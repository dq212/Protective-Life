...
describe("zipfile", function() {
    it("should be under /Users/dq212/Documents/CLIENTS/o2kl/GreatWest/Protective Life/Git-Banners/Protective-Life/5723_PL_2022_Nov_Animated_Banners/HI/320x50/node_modules/.bin/resize-bannekb", function() {
        var zip = fs.statSync("../HTML/5723_PL_2022_Nov_CI_Animated_Banner_320x50.zip");
...
describe("static image", function() {
    it("should match dimensions of the creative", function() {
        ...
        expect(dimensions.width).toBe(
            320,
            "\nIncorrect width on the static image. It should be 320px wide"
        );
        expect(dimensions.height).toBe(
            50,
            "\nIncorrect height on the static image. It should be 50px tall"
        );
    });
});
